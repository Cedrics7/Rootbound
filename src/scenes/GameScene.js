...
export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.time.addEvent({ delay: 1000, loop: true, callback: () => {
      ...
      // Symbiose passiv durch Symbiose-Mutationen
  ...
  _showGameOver() {
    ...
    this.time.delayedCall(800, () => {
      ...
      this.add.text(W/2,H*0.60,'Jahr '+this.seasons.year+' – '+this.tree.phase.name,{fontFamily:'sans-serif',fontSize:'15px',fill:'#806050'}).setOrigin(0.5).setDepth(51);
